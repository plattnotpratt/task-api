...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    tasks<T extends UserTasksArgs= {}>(args?: Subset<T, UserTasksArgs>): PrismaPromise<Array<TaskGetPayload<T>>| Null>;
  ...
  export type TaskGetPayload<S extends boolean | null | undefined | TaskArgs> =
    ...
    : S extends { select: any } & (TaskArgs | TaskFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> :  P extends keyof Task ? Task[P] : never
  } 
      : Task
